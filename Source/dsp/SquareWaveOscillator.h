...
/**
 * Square wave oscillator that produces values in the range of -1.0 to 1.0.
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(SquareWaveOscillator)
};
